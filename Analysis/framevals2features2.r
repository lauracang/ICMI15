...
nameID <- c("none", "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M", "N", "O", "P")
	...
	for (cover in 1:2) {
		...
		for (state in 1:2) {
			...
			for (gesture in 1:7) {
				...
				if (user == "07" && coverType == "none" && stateType == "static" && gestureType == "notouch") {}
				else if (user == "15" && coverType == "none" && stateType == "dynamic" && gestureType == "pat") {} 
				else if (user == "13" && coverType == "none" && stateType == "dynamic" && gestureType == "notouch") {}
				else if (user == "10" && coverType == "cover" && stateType == "dynamic" && gestureType == "notouch") {}
				else if (user == "10" && coverType == "none" && stateType == "static" && gestureType == "pat") {}
				else if (user == "08" && coverType == "none" && stateType == "static" && gestureType == "constant") {}
				else if (user == "06" && coverType == "none" && stateType == "dynamic" && gestureType == "rub") {}
				else if (user == "06" && coverType == "none" && stateType == "dynamic" && gestureType == "tickle") {}
				else if (user == "04" && coverType == "none" && stateType == "static" && gestureType == "tickle") {}
				else if (user == "04" && coverType == "none" && stateType == "dynamic" && gestureType == "notouch") {}
				else if (user == "04" && coverType == "cover" && stateType == "dynamic" && gestureType == "rub") {}
				else {
					...
					for (l in 4:7) {
						...
						framerow<-c(frametuple1, frametuple2, frametuple3, coverType, stateType, username, controller, gestureType)
...
write.table(windowFeatures, "allFrames2try.csv", sep =",", row.names=FALSE, col.names=FALSE)